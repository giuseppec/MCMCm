...
namespace SCYTHE {
  ...
  public:
    ...
    typedef SCYTHE::row_major_iterator<ttype> row_major_iterator;
    typedef SCYTHE::const_row_major_iterator<ttype> const_row_major_iterator;
    typedef SCYTHE::col_major_iterator<ttype> col_major_iterator;
    typedef SCYTHE::const_col_major_iterator<ttype> const_col_major_iterator;
    typedef SCYTHE::reverse_row_major_iterator<ttype>
      reverse_row_major_iterator;
    typedef SCYTHE::const_reverse_row_major_iterator<ttype>
      const_reverse_row_major_iterator;
    typedef SCYTHE::reverse_col_major_iterator<ttype>
      reverse_col_major_iterator;
    typedef SCYTHE::const_reverse_col_major_iterator<ttype>
